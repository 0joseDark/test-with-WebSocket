...
async def connect_to_server():
    ...
    try:
        ...
        start_receiving_messages()  # Inicia a thread para receber mensagens
...
# Função para iniciar a recepção de mensagens numa thread separada
def start_receiving_messages():
    loop = asyncio.new_event_loop()
    asyncio.set_event_loop(loop)
    loop.run_until_complete(receive_messages())

def start_receiving_messages_thread():
    receive_thread = Thread(target=start_receiving_messages, daemon=True)
